...
public class CompatibilityTest {
    ...
    public void perfectCompatibilityTest() {
        Profile profile1 = new Profile("a@b.com", "Tim", new RGB(255, 0, 0), 50);
        Profile profile2 = new Profile("b@c.com", "Tim", new RGB(255, 0, 0), 50);
    ...
    public void numberDiffCompatibilityTest() {
        Profile profile1 = new Profile("a@b.com", "Tim", new RGB(255, 0, 0), 1);
        Profile profile2 = new Profile("b@c.com", "Tim", new RGB(255, 0, 0), 10);
        int score = LoveEngine.compatibility(profile1, profile2);

        Assert.assertEquals(1, score);

        Profile profile3 = new Profile("a@b.com", "Tim", new RGB(255, 0, 0), 5);
        Profile profile4 = new Profile("b@c.com", "Tim", new RGB(255, 0, 0), 100);
